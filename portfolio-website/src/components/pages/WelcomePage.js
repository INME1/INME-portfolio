    ...
    return (
      <>
        ...
        <div className="overflow-hidden whitespace-nowrap w-full h-40 flex items-center">
          <div className={`text-4xl md:text-6xl lg:text-8xl xl:text-9xl font-bold select-none ${direction === 'right' ? 'scroll-right' : 'scroll-left'}`}
               style={{
                 color: '#fff',
            ...
            {words.map((word, index) => {
              ...
              return (
                <span
                  ...
                  style={{
                    color: shouldHighlight ? '#8B5CF6' : '#fff',
                    WebkitTextStroke: shouldHighlight ? 
                      '1px #8B5CF6' : '2px #8B5CF6',
